...
3.  **Refine** patients using
    [`patientDesigner()`](reference/patientDesigner.md).
...
[`PatientGenerator::availableModels()`](reference/availableModels.md).
...
[`hecateSearch()`](reference/hecateSearch.md). This allows users to
search for and insert valid OMOP concept IDs directly into the CDM
tables.
...
- **Vignette**:
  [`vignette("shiny-integration", package = "PatientGenerator")`](articles/shiny-integration.md)
