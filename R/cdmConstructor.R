cdmConstructor <- R6::R6Class("cdmConstructor",
                              public = list(
                                person = NULL,
                                ...
                                initialize = function() {
                                  ...
                                  self$observation_period <- cdmTable$new("observation_period")
                                  self$drug_exposure <- cdmTable$new("drug_exposure")
                                  self$condition_occurrence <- cdmTable$new("condition_occurrence")
                                  self$measurement <- cdmTable$new("measurement")
                                },
                                ...
                                getCdmData = function() {
                                  # browser()
                                  cdm_data <- list(person = self$person$data(),
                                  ...
                                  cdm_data_json <- jsonlite::toJSON(cdm_data,
                                                                    dataframe = "rows",
                                                                    pretty = TRUE,
                                                                    na = "null")
                              ...
                              private = list(
                                ...
                                .defaultPersonData = function() {
                                  ...
                                  if (private$.tableName == "observation_period") {
                                    values <- list(as.Date("2010-02-28"), as.Date("2015-02-28"), 44191562L)
                                  } else {
                                    values <- list(44191562L, as.Date("2010-02-28"), as.Date("2015-02-28"))
                                  }
                                ...
                                .constructNewRow = function(name_event_id, event_id, ...) {
                                  ...
                                  new_data <- c(
                                    setNames(list(event_id), name_event_id),
                                    ...
                                  )
