...
This article documents an end-to-end workflow with `PatientGenerator`:
...
All snippets below are usage examples for users to run locally.
They are displayed in documentation only and are not executed during website builds.
